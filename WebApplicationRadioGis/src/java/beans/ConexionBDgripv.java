...
public class ConexionBDgripv {
    ...
    public ConexionBDgripv() {

        DB_driver = "com.mysql.jdbc.Driver";
        url = "jdbc:mysql://localhost:3306/sistemagripv"; 		//URL base de datos poseidon // se encuentra en civil
        username = "root";                      			//usuario base de datos global poseidon
        password = "piolin";
        try {
            //Asignacin del Driver
            Class.forName(DB_driver);
        } catch (ClassNotFoundException ex) {
            Logger.getLogger(ConexionBDgripv.class.getName()).log(Level.SEVERE, null, ex);
        }
        try {
