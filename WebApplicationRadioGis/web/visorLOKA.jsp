    ...
    <body>
        ...
        <table>
            ...
            <tbody>
                <%
                    try {
                        String a = ConnectToUrlUsingBasicAuthentication.getData(ConnectToUrlUsingBasicAuthentication.URL1);
            ...
            <script>
                function initMap() {
                    ...
                    google.maps.event.addListener(map, 'click', function (event) {
                     ...
                     content:'<h1><a href="#"><p><b>contenido:</b></a></h1><ul><li>1</li><li>2</li></ul></p>'
                     });
